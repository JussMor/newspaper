                ...
                <li>
                  <a
                    phx-click={
                        JS.toggle(
                        to: "#item-settings",
                        in: {"transition-[height] transform ease-in-out duration-200", "h-0", "h-[56px]"},
                        out: {"transition-[height] transform ease-in-out duration-200", "h-[56px]","h-0"}
                      )
                    }
                    class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 mx-4 font-normal text-sm text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    href="#"
                  ...
                  <!-- Dropdown Menu Start -->
                  <div id="item-settings" class="overflow-hidden hidden"
                  >
                    <ul class=" flex flex-col">
                      <li>
                        <.link
                          class="group  flex items-center  rounded-md px-11 py-1 mx-4 font-normal text-sm text-bodydark2 duration-300 ease-in-out hover:bg-graydark hover:text-white"
