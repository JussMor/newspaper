            ...
            <ul class="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <a
                  ...
                  phx-click={
                    JS.toggle(
                      to: "#item-dashboard",
                      in:
                        {"ease-in duration-300", "opacity-0 -translate-y-8",
                         "opacity-100 translate-y-0"},
                      out:
                        {"ease-out duration-300", "opacity-100 -translate-y-0 ",
                ...
                >
                  ...
                  <svg
                    ...
                    classs="{ 'rotate-180': (selected === 'Dashboard') }"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="none"
                ...
                <!-- Dropdown Menu Start -->
                <div id="item-dashboard" class="translate transform overflow-hidden hidden">
                  <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                    <li>
                      <a
                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                        href="index.html"
                        classs="page === 'ecommerce' && '!text-white'"
                      >
                        eCommerce
                      </a>
                    </li>
              ...
              <li>
                <a
                  ...
                  classs="{ 'bg-graydark dark:bg-meta-4': (selected === 'Calendar') && (page === 'calendar') }"
                >
                  <svg
                    class="fill-current"
                    width="18"
              ...
              <li>
                <a
                  ...
                  classs="{ 'bg-graydark dark:bg-meta-4': (selected === 'Profile') && (page === 'profile') }"
                  classs="page === 'profile' && 'bg-graydark'"
                >
                  <svg
                    class="fill-current"
                    width="18"
              ...
              <li>
                <a
                  ...
                  classs="{ 'bg-graydark dark:bg-meta-4': (selected === 'Forms') || (page === 'formElements' || page === 'formLayout') }"
                >
                  <svg
                    class="fill-current"
                    width="18"
                  ...
                  <svg
                    class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                    classs="{ 'rotate-180': (selected === 'Forms') }"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="none"
                ...
                <!-- Dropdown Menu Start -->
                <div id="item-forms" class="translate transform overflow-hidden hidden">
                  <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                    <li>
                      <a
                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                        href="form-elements.html"
                        classs="page === 'formElements' && '!text-white'"
                      >
                        Form Elements
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        classs="page === 'formLayout' && '!text-white'"
                      >
                        Form Layout
                      </a>
                    </li>
              ...
              <li>
                <a
                  ...
                  classs="{ 'bg-graydark dark:bg-meta-4': (selected === 'Tables') && (page === 'tables') }"
                >
                  <svg
                    class="fill-current"
                    width="18"
              ...
              >
                <li>
                  <a
                    ...
                    classs="{ 'bg-graydark dark:bg-meta-4': (selected === 'Settings') && (page === 'settings') }"
                    classs="page === 'settings' && 'bg-graydark'"
                  >
                    <svg
                      class="fill-current"
                      width="18"
                  ...
                  <!-- Dropdown Menu Start -->
                  <div id="item-settings" class="translate transform overflow-hidden hidden">
                    <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                      <li>
                        <.link
                          class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
            ...
            <ul class="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <a
                  ...
                  classs="{ 'bg-graydark dark:bg-meta-4': (selected === 'Chart') && (page === 'Chart') }"
                >
                  <svg
                    class="fill-current"
                    width="18"
              ...
              <li>
                <a
                  ...
                  classs="{ 'bg-graydark dark:bg-meta-4': (selected === 'UiElements') || (page === 'alerts' || page === 'buttons') }"
                >
                  <svg
                    class="fill-current"
                    width="18"
                  ...
                  <svg
                    class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                    classs="{ 'rotate-180': (selected === 'UiElements') }"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="none"
                  ...
                  <ul class="mb-3 mt-4 flex flex-col gap-2 pl-6">
                    ...
                    <li>
                      <a
                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                        href="buttons.html"
                        classs="page === 'buttons' && '!text-white'"
                      >
                        Buttons
                      </a>
                    </li>
              ...
              <li>
                <a
                  ...
                  classs="{ 'bg-graydark dark:bg-meta-4': (selected === 'AuthPages') || (page === 'register' || page === 'login') }"
                >
                  <svg
                    class="fill-current"
                    width="18"
                  ...
                  <svg
                    class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                    classs="{ 'rotate-180': (selected === 'AuthPages') }"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="none"
                ...
                <!-- Dropdown Menu Start -->
                <div id="item-authpages" class="translate transform overflow-hidden hidden">
                  <ul class="mb-3 mt-4 flex flex-col gap-2 pl-6">
                    <li>
                      <a
                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                        href="signin.html"
                        classs="page === 'signin' && '!text-white'"
                      >
                        Sign In
                      </a>
                    </li>
