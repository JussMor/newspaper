defmodule NewspaperWeb.HeaderComponent do
            ...
            <span class="relative block h-5.5 w-5.5 cursor-pointer">
              ...
              <span class="du-block absolute right-0 h-full w-full rotate-45">
                <span
                  ...
                  classs="{ '!h-0 delay-[0]': !sidebarToggle }"
                >
                </span>
                <span
                  class="delay-400 absolute left-0 top-2.5 block h-0.5 w-full rounded-sm bg-black duration-200 ease-in-out dark:bg-white"
                  classs="{ '!h-0 dealy-200': !sidebarToggle }"
                >
                </span>
              </span>
            </span>
        ...
        <div class="flex items-center gap-3 2xsm:gap-7">
          <ul class="flex items-center gap-2 2xsm:gap-4">
            <li>
              <!-- Dark Mode Toggler -->
              <label
                classs="darkMode ? 'bg-primary' : 'bg-stroke'"
              ...
              >
                ...
                />
                <span
                  classs="darkMode && '!right-1 !translate-x-full'"
            ...
            <li
              ...
              phx-click={
                JS.toggle(
                  to: "#item-notifiication",
                  in: {"ease-in duration-300", "opacity-0 ", "opacity-100 "},
                  out: {"ease-out duration-300", "opacity-100  ", "opacity-20 "}
                )
              }
            ...
            >
              ...
              <!-- Dropdown Start -->
              <div
                id="item-notifiication"
                x-show="dropdownOpen"
                class="absolute hidden -right-27 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80"
              >
                <div class="px-4.5 py-3">
                  <h5 class="text-sm font-medium text-bodydark2">Notification</h5>
                </div>

                <ul class="flex h-[318px] flex-col overflow-y-auto">
                  <li>
                    <a
            ...
            >
              ...
              <div
                id="item-chat"
                x-show="dropdownOpen"
                class="absolute hidden -right-16 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80"
              >
                <div class="px-4.5 py-3">
          ...
          >
            <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
              ...
              <svg
                classs="dropdownOpen && 'rotate-180'"
            ...
            <div
              id="item-profile"
              x-show="dropdownOpen"
              class="absolute hidden right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
            >
